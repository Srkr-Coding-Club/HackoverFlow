...
//         <h1 className="text-6xl font-semibold mt-20 mb-4 titles">HACK OVERFLOW 2K24</h1>
...
const Banner = () => {
  ...
  return (
    <div className="flex flex-col h-screen md:flex-row items-center bg-gradient-to-r from-gray-800 to-gray-900 text-white py-10 px-5">
      ...
      {/* <p
  className="text-2xl md:text-3xl font-bold uppercase tracking-wide mb-4 mt-2.5"
  style={{
...
>
  ...
  <span className="text-base md:text-lg">Presents</span>
        ...
        <h1 className="text-6xl font-semibold mt-4 mb-4 titles">HACK OVERFLOW 2K24</h1>
        <p className="text-2xl mb-2 font-bold">25 - 26TH OCT</p>
        <p className="text-xl mb-8">HACK FOR A CHANGE !</p>
        <Countdown date={countdownDate} renderer={renderer} />
